...
const ConfigStep = ({ channel, settings, updateSetting, onNavigate }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Activation Status */}
      <div className={`flex items-center justify-between p-4 rounded-3xl border transition-all ${isActive ? 'bg-green-50/50 border-green-100 shadow-sm' : 'bg-gray-50 border-gray-100 opacity-60'}`}>
        <div>
      ...
      <div className="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm space-y-4">
        ...
        <p className="text-[10px] text-gray-400 font-medium italic">
           * Use phone number or Zalo Official Account ID.
        </p>
      </div>
